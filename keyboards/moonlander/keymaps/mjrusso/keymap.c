...
#define SEL_R LCMD(LSFT(KC_RGHT)) // Select text to the right
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [NAV] = LAYOUT_moonlander(
        ...
        _______, OS_SHFT, OS_CTRL, OS_ALT,  OS_CMD,  _______, _______,                 _______, KC_CAPS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
        _______, _______, _______, _______, _______, _______,                                   KC_END,  SEL_L,   KC_PGDN, KC_PGUP, SEL_R,   _______,
   ...
   [NUM] = LAYOUT_moonlander(
        ...
        _______, KC_SCLN, KC_4,    KC_5,    KC_6,    KC_EQL,  _______,                 _______, _______, OS_CMD,  OS_ALT,  OS_CTRL, OS_SHFT, _______,
   ...
   [SYM] = LAYOUT_moonlander(
        ...
        _______, KC_COLN, KC_DLR,  KC_PERC, KC_CIRC, KC_PLUS, _______,                _______, _______, OS_CMD,  OS_ALT,  OS_CTRL, OS_SHFT, _______,
   ...
   [MOUSE] = LAYOUT_moonlander(
        _______, _______, _______, _______, _______, _______, _______,                 _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______,                 _______, _______, _______, _______, _______, _______, _______,
        _______, OS_SHFT, OS_CTRL, OS_ALT,  OS_CMD,  _______, _______,                 _______, _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______,
   ...
   [MACRO] = LAYOUT_moonlander(
        ...
        _______, OS_SHFT, OS_CTRL, OS_ALT,  OS_CMD,  _______, _______,           _______, _______, SNAP_L,  SNAP_R,  SCOOT,   _______, _______,
    ...
    [KEEB] = LAYOUT_moonlander(
        ...
        _______, OS_SHFT, OS_CTRL, OS_ALT,  OS_CMD,  _______, _______,           _______, _______, _______, _______, _______,   RGB_TOG, _______,
